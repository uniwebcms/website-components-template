...
2. Create a Cloudflare Pages project as described in the next section and link it with the repository that you created in the previous step.
...
4. Check that your JavaScript files are publicly available via teh URL generated by Cloudflare.
