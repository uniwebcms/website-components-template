...
1- Create your own GitHub repository from this repository template ([leanr more](https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template))
<img src="[https://github.com/favicon.ico](https://docs.github.com/assets/cb-77734/mw-1440/images/help/repository/use-this-template-button.webp)" width="400">
1- Create a Cloudflare Pages project as described in the next section and link it with the repository that you created in the previous step.
1- Commit some change to the main branch and confirm that Cloudflare is rebuilding the project JavaScript bundle automatically. By default, your collection is `SimpleCollection`. As an example, change the text [code in Block.js file](src/SimpleCollection/components/Block.js) from `console.log('Congrats, the setup is successful!')` to something else.
1- Check that your JavaScript files are publicly available via teh URL generated by Cloudflare.
